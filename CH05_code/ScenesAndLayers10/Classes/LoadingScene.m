...
-(void) update:(ccTime)delta
{
	...
	// Free memory by releasing unused textures.
	// Note: this may not always be desirable. If all textures used by your game fit neatly into memory
	// at all times, you should keep them in memory by removing these two lines. Otherwise you'll create
	// additional loading times without a clear benefit.
